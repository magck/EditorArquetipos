<?php
    ...
    function crear_mind_jsmind_CLUSTER($aData,$aData1,$descripcion_de_xml,$dir){ //AGREGAR----------------------------------------------------
        $meta = crear_meta_jsmind("archetype","importe_editor","1.0");
        $format = crear_format_jsmind("node_tree");
        $hijos = crear_data_hijos_jsmind_CLUSTER($aData,$aData1,$descripcion_de_xml,$dir);
    ...
    if ($tmp_tipo_arquetipo == "INSTRUCTION") {
        ...
        echo crear_mind_jsmind_CLUSTER($aTrama1,$array_items,$descripcion_de_xml,"left");
    ...
    function crear_data_hijos_jsmind_CLUSTER($padres,$array_items,$descripcion_de_xml,$dir){ //funcion que crea los hijos de root (jsmind)-------------------
